...
import com.oilStationMap.handler.WX_CustomMenuHandler;
...
@Controller
@RequestMapping(value = "/wxCustomMenu", produces = "application/json;charset=utf-8")
public class WX_CustomMenuController {
    ...
    @Autowired
    private WX_CustomMenuHandler wx_CustomMenuHandler;
    ...
    public Map<String, Object> getCustomMenu(HttpServletRequest request) {
        ...
        try {
            ResultMapDTO resultMapDTO = wx_CustomMenuHandler.getCustomMenu(paramMap);
    ...
    public Map<String, Object> createCustomMenu(HttpServletRequest request) {
        ...
        try {
            ResultMapDTO resultMapDTO = wx_CustomMenuHandler.createCustomMenu(paramMap);
            resultMap.put("recordsFiltered", resultMapDTO.getResultListTotal());
            resultMap.put("data", resultMapDTO.getResultMap());
            resultMap.put("code", resultMapDTO.getCode());
            resultMap.put("message", resultMapDTO.getMessage());
    ...
    public Map<String, Object> deleteCustomMenu(HttpServletRequest request) {
        ...
        try {
            ResultMapDTO resultMapDTO = wx_CustomMenuHandler.deleteCustomMenu(paramMap);
            resultMap.put("recordsFiltered", resultMapDTO.getResultListTotal());
            resultMap.put("data", resultMapDTO.getResultMap());
            resultMap.put("code", resultMapDTO.getCode());
            resultMap.put("message", resultMapDTO.getMessage());
    ...
    public Map<String, Object> createPersonalMenu(HttpServletRequest request) {
        ...
        try {
            ResultMapDTO resultMapDTO = wx_CustomMenuHandler.createPersonalMenu(paramMap);
            resultMap.put("recordsFiltered", resultMapDTO.getResultListTotal());
            resultMap.put("data", resultMapDTO.getResultMap());
            resultMap.put("code", resultMapDTO.getCode());
            resultMap.put("message", resultMapDTO.getMessage());
    ...
    public Map<String, Object> deletePersonalMenu(HttpServletRequest request) {
        ...
        try {
            ResultMapDTO resultMapDTO = wx_CustomMenuHandler.deletePersonalMenu(paramMap);
            resultMap.put("recordsFiltered", resultMapDTO.getResultListTotal());
            resultMap.put("data", resultMapDTO.getResultMap());
            resultMap.put("code", resultMapDTO.getCode());
            resultMap.put("message", resultMapDTO.getMessage());
    ...
    public Map<String, Object> getCurrentSelfMenuInfo(HttpServletRequest request) {
        ...
        try {
            ResultMapDTO resultMapDTO = wx_CustomMenuHandler.getCurrentSelfMenuInfo(paramMap);
            resultMap.put("recordsFiltered", resultMapDTO.getResultListTotal());
            resultMap.put("data", resultMapDTO.getResultMap());
            resultMap.put("code", resultMapDTO.getCode());
            resultMap.put("message", resultMapDTO.getMessage());
