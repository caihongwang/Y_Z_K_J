...
import com.oilStationMap.handler.WX_SourceMaterialHandler;
...
@Controller
@RequestMapping(value = "/wxSourceMaterial", produces = "application/json;charset=utf-8")
public class WX_SourceMaterialController {
    ...
    public Map<String, Object> batchGetMaterial(HttpServletRequest request) {
        ...
        try {
            ResultMapDTO resultMapDTO = wx_SourceMaterialHandler.batchGetMaterial(paramMap);
