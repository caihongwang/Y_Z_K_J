...
import com.oilStationMap.dao.WX_UserFormMappingDao;
...
public class WX_RedPacketServiceImpl implements WX_RedPacketService {
    ...
    @Autowired
    private WX_UserFormMappingDao wxUserFormMappingDao;
    ...
    public ResultMapDTO getOauth(Map<String, Object> paramMap) {
        ...
        if (!"".equals(code) && code != null) {
            String appId = OilStationMapCode.WX_PUBLIC_NUMBER_APPID;
            String secret = OilStationMapCode.WX_PUBLIC_NUMBER_SECRET;
    ...
    public ResultMapDTO getToOauthUrl(Map<String, Object> paramMap) {
        Map<String, Object> resultMap = Maps.newHashMap();
        ResultMapDTO resultMapDTO = new ResultMapDTO();
        String calbackUrl = OilStationMapCode.WX_PAY_DOMAIN + "/wxRedPacket/getOauth.do";
        String toOauthUrl = WX_PublicNumberUtil.getAuthorizeURL(OilStationMapCode.WX_PUBLIC_NUMBER_APPID, calbackUrl, "111", false);
    ...
    public ResultMapDTO enterprisePayment(Map<String, Object> paramMap) {
        ...
        if (paramMap.size() > 0 && !"".equals(wxPublicNumGhId)) {
            ...
            if (dicResultDto.getResultList() != null
                ...
                resultMapDTO.setCode(OilStationMapCode.WX_RED_PACKET__ACTIVITY_IS_NOT_EXIST.getNo());
                resultMapDTO.setMessage(OilStationMapCode.WX_RED_PACKET__ACTIVITY_IS_NOT_EXIST.getMessage());
            }
        } else {
    ...
    public ResultMapDTO sendRedPacket(Map<String, Object> paramMap) {
        ...
        if (paramMap.size() > 0 && !"".equals(wxPublicNumGhId)) {
            ...
            if (dicResultDto.getResultList() != null
                ...
                // 微信支付分配的商户号
                String mchId = OilStationMapCode.WX_PAY_MCH_ID;
                //商户相关资料
                String wxAppId = OilStationMapCode.WX_PUBLIC_NUMBER_APPID;
                //商户名称:红包发送者名称
                ...
                //红包发放总人数
                String totalNum = OilStationMapCode.WX_RED_PACK_NUMBER;
                //红包祝福语
                ...
                //API密钥
                String paternerKey = OilStationMapCode.WX_PAY_API_SECRET;
                //微信证书路径
                String certPath = OilStationMapCode.WX_PAY_CERT_PATH;
                //发送红包
                ...
                if (isSend) {
                    ...
                    resultMapDTO.setCode(OilStationMapCode.WX_RED_PACKET__SEND_SUCCESS.getNo());
                    resultMapDTO.setMessage(OilStationMapCode.WX_RED_PACKET__SEND_SUCCESS.getMessage());
                } else {

                    resultMapDTO.setCode(OilStationMapCode.WX_RED_PACKET__SEND_FAILTURE.getNo());
                    resultMapDTO.setMessage(OilStationMapCode.WX_RED_PACKET__SEND_FAILTURE.getMessage());
                }
            } else {
