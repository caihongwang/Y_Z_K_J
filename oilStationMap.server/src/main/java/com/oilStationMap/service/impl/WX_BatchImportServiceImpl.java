...
import com.oilStationMap.vo.ContactVO;
import com.oilStationMap.service.WX_BatchImportService;
import com.oilStationMap.utils.ImportExcelUtil;
 ...
 */
@Service
public class WX_BatchImportServiceImpl implements WX_BatchImportService {
        ...
        if (!"".equals(destFilePath)) {
            ...
            if (contactVOList != null && contactVOList.size() > 0) {
                ...
                for (ContactVO ContactVO : contactVOList) {
                    try {
                        Map<String, Object> paramMap_ContactPO = MapUtil.objectToMap(ContactVO);
