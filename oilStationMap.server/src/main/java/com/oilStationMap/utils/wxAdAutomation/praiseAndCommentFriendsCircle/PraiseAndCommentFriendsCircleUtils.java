...
public class PraiseAndCommentFriendsCircleUtils {
    ...
    public static void praiseAndCommentFriendsCircle(Map<String, Object> paramMap) throws Exception {
        ...
        for (String currentDateStr : currentDateList) {
            ...
            praiseAndCommentFriendsCircleParam.putAll(paramMap);
            ...
            dicCodeList.add("HuaWeiListAndPraiseAndCommentFriendsCircleLocaltion");//获取 华为 Mate 8 设备列表和配套的坐标配置
                        ...
                        for (Map<String, Object> deviceNameMap : deviceNameList) {
                            ...
                            try {
                                ...
                                if (startHour.equals(currentHour)) {
                                    deviceName = praiseAndCommentFriendsCircleParam.get("deviceName").toString();
                                    deviceNameDesc = praiseAndCommentFriendsCircleParam.get("deviceNameDesc").toString();
                                    //开始点赞和评论朋友圈
                                    logger.info("设备编码【" + praiseAndCommentFriendsCircleParam.get("deviceName") + "】设备描述【" + praiseAndCommentFriendsCircleParam.get("deviceNameDesc") + "】将点赞和评论朋友圈即将开始发送....");
                                    new com.oilStationMap.utils.wxAdAutomation.praiseAndCommentFriendsCircle.RealMachineDevices().praiseAndCommentFriendsCircle(praiseAndCommentFriendsCircleParam);
                                    Thread.sleep(5000);
//                                    //重新操作
//                                    reboot_praiseAndCommentFriendsCircleParam.putAll(praiseAndCommentFriendsCircleParam);
                                } else {
                                    //下一个设备
                                    logger.info("设备编码【" + praiseAndCommentFriendsCircleParam.get("deviceName") + "】设备描述【" + praiseAndCommentFriendsCircleParam.get("deviceNameDesc") + "】，当前设备的执行时间第【" + startHour + "】小时，当前时间是第【" + currentHour + "】小时....");
                                    continue;
                                }
                            } catch (Exception e) {
                                e.printStackTrace();
            ...
            while (reboot_praiseAndCommentFriendsCircleParam.size() > 0) {
                ...
                try {
                    logger.info("设备编码【" + deviceName + "】设备描述【" + deviceNameDesc + "】将点赞和评论朋友圈即将开始发送....");
                    new RealMachineDevices().praiseAndCommentFriendsCircle(reboot_praiseAndCommentFriendsCircleParam);
            ...
            if (reboot_praiseAndCommentFriendsCircleParam.size() > 0) {
                logger.info("设备编码【" + deviceName + "】设备描述【" + deviceNameDesc + "】【点赞和评论朋友圈】5次次批量执行均失败的设备如下....");
                logger.info("设备编码【" + deviceName + "】设备描述【" + deviceNameDesc + "】【点赞和评论朋友圈】5次次批量执行均失败的设备如下....");
                logger.info("设备编码【" + deviceName + "】设备描述【" + deviceNameDesc + "】【点赞和评论朋友圈】5次次批量执行均失败的设备如下....");
                logger.info("设备编码【" + deviceName + "】设备描述【" + deviceNameDesc + "】【点赞和评论朋友圈】5次次批量执行均失败的设备如下....");
                logger.info("设备编码【" + deviceName + "】设备描述【" + deviceNameDesc + "】【点赞和评论朋友圈】5次次批量执行均失败的设备如下....");
                ...
                logger.info("设备编码【" + deviceName + "】设备描述【" + deviceNameDesc + "】【点赞和评论朋友圈】5次次批量执行均失败的设备如上....");
                logger.info("设备编码【" + deviceName + "】设备描述【" + deviceNameDesc + "】【点赞和评论朋友圈】5次次批量执行均失败的设备如上....");
                logger.info("设备编码【" + deviceName + "】设备描述【" + deviceNameDesc + "】【点赞和评论朋友圈】5次次批量执行均失败的设备如上....");
                logger.info("设备编码【" + deviceName + "】设备描述【" + deviceNameDesc + "】【点赞和评论朋友圈】5次次批量执行均失败的设备如上....");
                logger.info("设备编码【" + deviceName + "】设备描述【" + deviceNameDesc + "】【点赞和评论朋友圈】5次次批量执行均失败的设备如上....");
                ...
                logger.info("设备编码【" + deviceName + "】设备描述【" + deviceNameDesc + "】【点赞和评论朋友圈】全部执行成功....");
                logger.info("设备编码【" + deviceName + "】设备描述【" + deviceNameDesc + "】【点赞和评论朋友圈】全部执行成功....");
                logger.info("设备编码【" + deviceName + "】设备描述【" + deviceNameDesc + "】【点赞和评论朋友圈】全部执行成功....");
                logger.info("设备编码【" + deviceName + "】设备描述【" + deviceNameDesc + "】【点赞和评论朋友圈】全部执行成功....");
                logger.info("设备编码【" + deviceName + "】设备描述【" + deviceNameDesc + "】【点赞和评论朋友圈】全部执行成功....");
