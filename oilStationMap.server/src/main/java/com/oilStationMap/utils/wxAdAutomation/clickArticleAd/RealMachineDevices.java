package com.oilStationMap.utils.wxAdAutomation.clickArticleAd;
...
import com.oilStationMap.utils.wxAdAutomation.clickArticleAd.ClickArticleAd;
 ...
 * 默认 华为 Mate 8
 */
public class RealMachineDevices implements ClickArticleAd {
     ...
     */
    @Override
    public void clickArticleAd(Map<String, Object> paramMap) throws Exception {
...
//            webElement.click();
        ...
        //10.点击坐标【广告】
        try{
            String temp = "//android.widget.FrameLayout/android.widget.FrameLayout[1]/android.webkit.WebView/android.view.View/android.view.View[2]/android.view.View[1]/android.view.View[3]";
            WebElement allWebElement = ElementJudgeMethodUtil.waitForElementPresent(driver, By.xpath(temp), 10);
            List<WebElement> list = allWebElement.findElements(By.className("android.view.View"));
            WebElement webElement = null;
            for(WebElement we : list) {
                String resourceId = we.getAttribute("resource-id");
                if("main-img".equals(resourceId)){  //广告的图片
                    webElement = we;
                    break;
                }
                logger.info("id ----------------------->>>>> " + we.getAttribute("resource-id"));
            }
            Point point = webElement.getLocation();
            SwipeUtil.Swipe2Point(driver, point);               //不准确.
//            webElement.click();
//            Thread.sleep(5000);
//            //11.向上滑动微信文章
//            for(int i = 0; i <= 7; i++){
...
//            }
            sw.split();
            logger.info("点击坐标【广告】成功，总共花费 " + sw.toSplitString() + " 秒....");
            Thread.sleep(1000);
        } catch (Exception e) {
            sw.split();
            e.printStackTrace();
    ...
    public static void main(String[] args) {
        try{
            ...
            new RealMachineDevices().clickArticleAd(paramMap);
            Thread.sleep(5000);
        } catch (Exception e) {
            e.printStackTrace();
        }
