 ...
 * 默认 华为 Mate 8
 */
public class RealMachineDevices_Localtion implements SendFriendCircle {
...
//                    String pushCommandStr = "/opt/android_sdk/platform-tools/adb -s " + deviceName + " push " + imgPath + " " + phoneLocalPath;
...
//            }
    ...
    public static void main(String[] args) {
        try {
            ...
            new RealMachineDevices_Localtion().sendFriendCircle(paramMap, sw);
            Thread.sleep(5000);
        } catch (Exception e) {
            e.printStackTrace();
        }
