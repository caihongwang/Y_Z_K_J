 ...
 * 默认 华为 Mate 8
 */
public class RealMachineDevices_Localtion implements ShareArticleToFriendCircle{
...
//            }
    ...
    public static void main(String[] args) {
        try{
            ...
            new RealMachineDevices_Localtion().shareArticleToFriendCircle(paramMap, sw);
            Thread.sleep(5000);
        } catch (Exception e) {
            e.printStackTrace();
        }
