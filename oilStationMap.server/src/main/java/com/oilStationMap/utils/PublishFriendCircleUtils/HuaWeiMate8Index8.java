...
/**
 * 华为 Mate 8 _ 8 发布朋友圈 策略
 */
public class HuaWeiMate8Index8 implements FriendCircleStraetge{

    public static final Logger logger = LoggerFactory.getLogger(HuaWeiMate8Index8.class);
    ...
    public void sendFriendCircle(Map<String, Object> paramMap) throws Exception {
        ...
        String deviceName = "QVM7N15C19001262";               //设备编码
        String deviceNameDesc = "华为 Mate 8 _ 8";       //设备描述
        //1.配置连接android驱动
