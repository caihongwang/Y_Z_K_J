...
/**
 * 华为 Mate 8 _ 7 发布朋友圈 策略
 */
public class HuaWeiMate8Index7 implements FriendCircleStraetge{

    public static final Logger logger = LoggerFactory.getLogger(HuaWeiMate8Index7.class);
    ...
    public void sendFriendCircle(Map<String, Object> paramMap) throws Exception {
        ...
        String deviceName = "DLQ0216303004491";               //设备编码
        String deviceNameDesc = "华为 Mate 8 _ 7";       //设备描述
        //1.配置连接android驱动
