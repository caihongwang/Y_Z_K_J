package com.oilStationMap.utils.jsapi;
...
public class JsapiTicketUtil {
    ...
    public static String getAccessToken() {
        String appid = OilStationMapCode.WX_PUBLIC_NUMBER_APPID;//应用ID
        String appSecret = OilStationMapCode.WX_PUBLIC_NUMBER_SECRET;//(应用密钥)
