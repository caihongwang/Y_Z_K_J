...
wget -P /Users/caihongwang/Workspaces/MyProgram_Git/Y_Z_K_J/oilStationMap.server/target/ http://www.yzkj.store/resourceOfOilStationMap/webapp/mysqlDataBak/AllDataBase_${current_date}.sql
