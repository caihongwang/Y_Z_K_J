...
public class WX_OrderHandler {
    ...
    private static final Logger logger = LoggerFactory.getLogger(com.newMall.handler.WX_OrderHandler.class);
     ...
     * @throws
     */
    public ResultMapDTO purchaseProductInMiniProgram(int tid, Map<String, String> paramMap) {
     ...
     * @throws
     */
    public ResultMapDTO wxPayNotifyForPurchaseProductInMiniProgram(int tid, Map<String, String> paramMap) {
     ...
     * @throws
     */
    public ResultMapDTO payTheBillInMiniProgram(int tid, Map<String, String> paramMap) {
     ...
     * @throws
     */
    public ResultMapDTO wxPayNotifyForPayTheBillInMiniProgram(int tid, Map<String, String> paramMap) {
     ...
     * @throws
     */
    public BoolDTO addOrder(int tid, Map<String, String> paramMap) {
     ...
     * @throws
     */
    public BoolDTO deleteOrder(int tid, Map<String, String> paramMap) {
     ...
     * @throws
     */
    public BoolDTO updateOrder(int tid, Map<String, String> paramMap) {
     ...
     * @throws
     */
    public ResultDTO getSimpleOrderByCondition(int tid, Map<String, String> paramMap) {
     ...
     * @throws
     */
    public ResultDTO getOrderByCondition(int tid, Map<String, String> paramMap) {
     ...
     * @throws
     */
    public ResultDTO getAllPayGoodsOrder(int tid, Map<String, String> paramMap) {
     ...
     * @throws
     */
    public ResultDTO getWaitPayGoodsOrder(int tid, Map<String, String> paramMap) {
     ...
     * @throws
     */
    public ResultDTO getAlreadyPayGoodsOrder(int tid, Map<String, String> paramMap) {
     ...
     * @throws
     */
    public ResultDTO getAlreadyDeliverGoodsOrder(int tid, Map<String, String> paramMap) {
     ...
     * @throws
     */
    public ResultDTO getCompletedGoodsOrder(int tid, Map<String, String> paramMap) {
     ...
     * @throws
     */
    public BoolDTO confirmReceiptGoodsOrder(int tid, Map<String, String> paramMap) {
     ...
     * @throws
     */
    public ResultMapDTO getGoodsOrderDetailById(int tid, Map<String, String> paramMap) {
     ...
     * @throws
     */
    public ResultDTO getAllFoodsOrder(int tid, Map<String, String> paramMap) {
     ...
     * @throws
     */
    public ResultDTO getWaitPayFoodsOrder(int tid, Map<String, String> paramMap) {
     ...
     * @throws
     */
    public ResultDTO getAlreadyPayFoodsOrder(int tid, Map<String, String> paramMap) {
     ...
     * @throws
     */
    public ResultMapDTO getFoodsOrderDetailById(int tid, Map<String, String> paramMap) {
