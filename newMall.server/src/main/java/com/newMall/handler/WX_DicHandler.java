...
public class WX_DicHandler {
    ...
    private static final Logger logger = LoggerFactory.getLogger(com.newMall.handler.WX_DicHandler.class);
     ...
     * @throws
     */
    public BoolDTO addDic(int tid, Map<String, String> paramMap) {
     ...
     * @throws
     */
    public BoolDTO deleteDic(int tid, Map<String, String> paramMap) {
     ...
     * @throws
     */
    public BoolDTO updateDic(int tid, Map<String, String> paramMap) {
     ...
     * @throws
     */
    public ResultDTO getSimpleDicByCondition(int tid, Map<String, String> paramMap) {
     ...
     * @throws
     */
    public ResultMapDTO getMoreDicByCondition(int tid, Map<String, String> paramMap) {
