...
import com.newMall.service.WX_CustomMenuService;
...
public class WX_CustomMenuHandler {
    ...
    private static final Logger logger = LoggerFactory.getLogger(com.newMall.handler.WX_CustomMenuHandler.class);
     ...
     * @throws
     */
    public ResultMapDTO getCustomMenu(int tid, Map<String, String> paramMap) {
     ...
     * @throws
     */
    public ResultMapDTO createCustomMenu(int tid, Map<String, String> paramMap) {
     ...
     * @throws
     */
    public ResultMapDTO deleteCustomMenu(int tid, Map<String, String> paramMap) {
     ...
     * @throws
     */
    public ResultMapDTO createPersonalMenu(int tid, Map<String, String> paramMap) {
     ...
     * @throws
     */
    public ResultMapDTO deletePersonalMenu(int tid, Map<String, String> paramMap) {
     ...
     * @throws
     */
    public ResultMapDTO getCurrentSelfMenuInfo(int tid, Map<String, String> paramMap) {
