...
public class CommonHandler {
     ...
     * @throws
     */
    public ResultMapDTO getDecryptPhone(int tid, Map<String, String> paramMap) {
    ...
    public ResultMapDTO sendTemplateMessageForWxPublicNumber(int tid, Map<String, String> paramMap) {
    ...
    public ResultMapDTO sendTemplateMessageForMiniProgram(int tid, Map<String, String> paramMap) {
    ...
    public ResultMapDTO getOpenIdAndSessionKeyForWX(int tid, Map<String, String> paramMap) {
    ...
    public ResultMapDTO getSignatureAndJsapiTicketAndNonceStrForWxPublicNumber(int tid, Map<String, String> paramMap) {
    ...
    public ResultMapDTO receviceAndSendCustomMessage(int tid, Map<String, String> paramMap) {
