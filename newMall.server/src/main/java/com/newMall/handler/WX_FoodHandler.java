...
import com.newMall.service.WX_FoodService;
...
public class WX_FoodHandler {
     ...
     * @throws
     */
    public BoolDTO addFood(int tid, Map<String, String> paramMap) {
     ...
     * @throws
     */
    public BoolDTO deleteFood(int tid, Map<String, String> paramMap) {
     ...
     * @throws
     */
    public BoolDTO updateFood(int tid, Map<String, String> paramMap) {
     ...
     * @throws
     */
    public ResultDTO getSimpleFoodByCondition(int tid, Map<String, String> paramMap) {
     ...
     * @throws
     */
    public ResultMapDTO getMenuByCondition(int tid, Map<String, String> paramMap) {
