...
import com.newMall.service.RedPacketDrawCashHistoryService;
 ...
 */
@Component
public class RedPacketDrawCashHistoryHandler {
    ...
    public ResultMapDTO getDrawCashMoneyTotal(int tid, Map<String, String> paramMap) {
    ...
    public ResultDTO getRedPacketDrawCashHistory(int tid, Map<String, String> paramMap) {
