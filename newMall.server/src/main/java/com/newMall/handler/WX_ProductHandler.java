...
import com.newMall.service.WX_ProductService;
 ...
 */
@Component
public class WX_ProductHandler {
     ...
     * @throws
     */
    public ResultDTO getOrUpdateProductFrom7Dingdong(int tid, Map<String, String> paramMap) {
     ...
     * @throws
     */
    public ResultDTO getProductTypeList(int tid, Map<String, String> paramMap) {
     ...
     * @throws
     */
    public BoolDTO addProduct(int tid, Map<String, String> paramMap) {
     ...
     * @throws
     */
    public BoolDTO deleteProduct(int tid, Map<String, String> paramMap) {
     ...
     * @throws
     */
    public BoolDTO updateProduct(int tid, Map<String, String> paramMap) {
     ...
     * @throws
     */
    public ResultDTO getSimpleProductByCondition(int tid, Map<String, String> paramMap) {
     ...
     * @throws
     */
    public ResultDTO getProductList(int tid, Map<String, String> paramMap) {
     ...
     * @throws
     */
    public ResultMapDTO getProductDetail(int tid, Map<String, String> paramMap) {
