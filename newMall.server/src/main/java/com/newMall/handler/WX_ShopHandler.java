...
import com.newMall.service.WX_ShopService;
...
public class WX_ShopHandler {
     ...
     * @throws
     */
    public ResultDTO getOrderSortTypeList(int tid, Map<String, String> paramMap) {
     ...
     * @throws
     */
    public BoolDTO addShop(int tid, Map<String, String> paramMap) {
     ...
     * @throws
     */
    public BoolDTO deleteShop(int tid, Map<String, String> paramMap) {
     ...
     * @throws
     */
    public BoolDTO updateShop(int tid, Map<String, String> paramMap) {
     ...
     * @throws
     */
    public ResultDTO getSimpleShopByCondition(int tid, Map<String, String> paramMap) {
     ...
     * @throws
     */
    public ResultDTO getShopByCondition(int tid, Map<String, String> paramMap) {
     ...
     * @throws
     */
    public ResultMapDTO getShopMiniProgramCode(int tid, Map<String, String> paramMap) {
