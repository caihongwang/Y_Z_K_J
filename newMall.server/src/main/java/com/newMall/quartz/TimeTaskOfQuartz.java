package com.newMall.quartz;

import com.newMall.service.*;
...
public class TimeTaskOfQuartz {
    ...
    private static final org.slf4j.Logger logger = LoggerFactory.getLogger(com.newMall.quartz.TimeTaskOfQuartz.class);
