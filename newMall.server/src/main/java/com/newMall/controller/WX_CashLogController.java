...
import com.newMall.handler.WX_CashLogHandler;
...
public class WX_CashLogController {
    ...
    @Autowired
    private WX_CashLogHandler wxCashLogHandler;
     ...
     * @return
     */
    @RequestMapping("/cashedRulePage")
    public String cashedRulePage(HttpServletRequest request) {
        Map<String, String> paramMap = new HashMap<String, String>();
        Map<String, Object> resultMap = new HashMap<String, Object>();
        //获取请求参数能够获取到并解析
        paramMap = HttpUtil.getRequestParams(request);
