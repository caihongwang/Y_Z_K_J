...
import com.newMall.handler.WX_CustomMenuHandler;
...
public class WX_CustomMenuController {
    ...
    private static final Logger logger = LoggerFactory.getLogger(com.newMall.controller.WX_CustomMenuController.class);
