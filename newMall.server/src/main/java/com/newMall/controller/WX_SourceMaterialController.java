...
import com.newMall.handler.WX_SourceMaterialHandler;
...
public class WX_SourceMaterialController {
    ...
    private static final Logger logger = LoggerFactory.getLogger(com.newMall.controller.WX_SourceMaterialController.class);

    @Autowired
    private WX_SourceMaterialHandler wx_SourceMaterialHandler;
    ...
    public String redirectMaterialUrl(HttpServletRequest request) {
        ...
        paramMap = HttpUtil.getRequestParams(request);
        logger.info("在controller中获取素材列表-batchGetMaterial,请求-paramMap:" + paramMap);
        String materialUrl = "https://www.yzkj.store/newMall/payment.html";
