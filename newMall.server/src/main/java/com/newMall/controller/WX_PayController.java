...
import com.newMall.handler.WX_PayHandler;
...
public class WX_PayController {
    ...
    private static final Logger logger = LoggerFactory.getLogger(com.newMall.controller.WX_PayController.class);
    ...
    public String getToOauthUrl(HttpServletRequest request) {
        ...
        String toOauthUrl = "https://www.yzkj.store/newMall/wx_Pay/getOauth.do";
        try {
    ...
    public String getOauth(HttpServletRequest request) {
        ...
        String paymentUrl = "https://www.yzkj.store/newMall/payment.html";
        try {
