...
import com.newMall.handler.WX_DicHandler;
...
public class WX_DicController {
    ...
    private static final Logger logger = LoggerFactory.getLogger(com.newMall.controller.WX_DicController.class);
    ...
    public Map<String, Object> addDic(HttpServletRequest request) {
        ...
        logger.info("【controller】添加字典-addDic,请求-paramMap = {}", JSONObject.toJSONString(paramMap));
        try {
            ...
            logger.error("【controller】添加字典-addDic is error, paramMap : {}", JSONObject.toJSONString(paramMap), " , e : {}", e);
        ...
        logger.info("【controller】添加字典-addDic,响应-resultMap = {}", JSONObject.toJSONString(resultMap));
        return resultMap;
    }
    ...
    public Map<String, Object> deleteDic(HttpServletRequest request) {
        ...
        //获取请求参数能够获取到并解析
        paramMap = HttpUtil.getRequestParams(request);
        logger.info("【controller】删除字典-deleteDic,请求-paramMap = {}", JSONObject.toJSONString(paramMap));
        try {
            ...
            logger.error("【controller】删除字典-deleteDic is error, paramMap : {}", JSONObject.toJSONString(paramMap), " , e : {}", e);
            resultMap.put("success", false);
            resultMap.put("code", NewMallCode.SERVER_INNER_ERROR.getNo());
            resultMap.put("message", NewMallCode.SERVER_INNER_ERROR.getMessage());
        }
        logger.info("【controller】删除字典-deleteDic,响应-resultMap = {}", JSONObject.toJSONString(resultMap));
        return resultMap;
    }
    ...
    public Map<String, Object> updateDic(HttpServletRequest request) {
        ...
        //获取请求参数能够获取到并解析
        paramMap = HttpUtil.getRequestParams(request);
        logger.info("【controller】修改字典-updateDic,请求-paramMap = {}", JSONObject.toJSONString(paramMap));
        try {
            ...
            logger.error("【controller】修改字典-updateDic is error, paramMap : {}", JSONObject.toJSONString(paramMap), " , e : {}", e);
            resultMap.put("success", false);
            resultMap.put("code", NewMallCode.SERVER_INNER_ERROR.getNo());
            resultMap.put("message", NewMallCode.SERVER_INNER_ERROR.getMessage());
        }
        logger.info("【controller】修改字典-updateDic,响应-resultMap = {}", JSONObject.toJSONString(resultMap));
        return resultMap;
    }
    ...
    public Map<String, Object> getSimpleDicByCondition(HttpServletRequest request) {
        ...
        //获取请求参数能够获取到并解析
        paramMap = HttpUtil.getRequestParams(request);
        logger.info("【controller】获取单一的字典-getSimpleDicByCondition,请求-paramMap = {}", JSONObject.toJSONString(paramMap));
        try {
            ...
            logger.error("【controller】获取单一的字典-getSimpleDicByCondition is error, paramMap : {}", JSONObject.toJSONString(paramMap), " , e : {}", e);
            resultMap.put("success", false);
            resultMap.put("code", NewMallCode.SERVER_INNER_ERROR.getNo());
            resultMap.put("message", NewMallCode.SERVER_INNER_ERROR.getMessage());
        }
        logger.info("【controller】获取单一的字典-getSimpleDicByCondition,响应-resultMap = {}", JSONObject.toJSONString(resultMap));
        return resultMap;
    }
    ...
    public Map<String, Object> getMoreDicByCondition(HttpServletRequest request) {
        ...
        //获取请求参数能够获取到并解析
        paramMap = HttpUtil.getRequestParams(request);
        logger.info("【controller】获取多个的字典-getMoreDicByCondition,请求-paramMap = {}", JSONObject.toJSONString(paramMap));
        try {
            ...
            logger.error("【controller】获取多个的字典-getMoreDicByCondition is error, paramMap : {}", JSONObject.toJSONString(paramMap), " , e : {}", e);
            resultMap.put("success", false);
            resultMap.put("code", NewMallCode.SERVER_INNER_ERROR.getNo());
            resultMap.put("message", NewMallCode.SERVER_INNER_ERROR.getMessage());
        }
        logger.info("【controller】获取多个的字典-getMoreDicByCondition,响应-resultMap = {}", JSONObject.toJSONString(resultMap));
        return resultMap;
    }
