...
import com.newMall.handler.WX_RedPacketHandler;
...
public class WX_RedPacketController {
    ...
    private static final Logger logger = LoggerFactory.getLogger(com.newMall.controller.WX_RedPacketController.class);
    ...
    public String getToOauthUrl(HttpServletRequest request) {
        ...
        String toOauthUrl = " https://www.yzkj.store/newMall/wx_RedPacket/getOauth.do";
        try {
    ...
    public String redActivityRulePage(HttpServletRequest request) {
        ...
        String redActivityRuleUrl = "https://www.yzkj.store/newMall/redActivity/redActivityRule/index.html";
