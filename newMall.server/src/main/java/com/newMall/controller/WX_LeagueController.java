...
import com.newMall.handler.WX_LeagueHandler;
...
public class WX_LeagueController {
    ...
    private static final Logger logger = LoggerFactory.getLogger(com.newMall.controller.WX_LeagueController.class);
