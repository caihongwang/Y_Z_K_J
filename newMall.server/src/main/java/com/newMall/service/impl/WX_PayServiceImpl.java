...
public class WX_PayServiceImpl implements WX_PayService {
    ...
    public ResultMapDTO unifiedOrderPay(Map<String, Object> paramMap) {
        ...
        if (!"".equals(openId) && !"".equals(spbillCreateIp)) {
            if ("".equals(payMoney)) {
                ...
                String unifiedOrderPayJson = com.newMall.utils.WX_PayUtil.unifiedOrderPay(
                        appId, mchId, body ,
                ...
                resultMapDTO.setResultMap(com.newMall.utils.MapUtil.getStringMap(unifiedOrderPayMap));
    ...
    public ResultMapDTO getToOauthUrl(Map<String, Object> paramMap) {
        ...
        try{
            ...
            String toOauthUrl = com.newMall.utils.WX_PublicNumberUtil.getAuthorizeURL(NewMallCode.WX_PUBLIC_NUMBER_APPID, calbackUrl, "123", false);
