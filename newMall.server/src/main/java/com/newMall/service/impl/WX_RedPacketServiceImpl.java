...
import com.newMall.dao.UserFormMappingDao;
...
public class WX_RedPacketServiceImpl implements WX_RedPacketService {
    ...
    public ResultMapDTO getRedPacketQrCode(Map<String, Object> paramMap) {
        ...
        if (paramMap.size() > 0 && !"".equals(uid) && !"".equals(phone)) {
            ...
            String qrCodeImg_url = com.newMall.utils.WX_PublicNumberUtil.getRedPacketQrCode(paramStr);
            resultMap.put("qrCodeImg_url", qrCodeImg_url);
            resultMapDTO.setResultMap(com.newMall.utils.MapUtil.getStringMap(resultMap));
    ...
    public ResultMapDTO getOauth(Map<String, Object> paramMap) {
        ...
        if (!"".equals(code) && code != null) {
            ...
            Map<String, Object> snsAccessTokenMap = com.newMall.utils.WX_PublicNumberUtil.getSnsAccessToken(appId, secret, code);
            ...
            if (!"".equals(accessToken) && !"".equals(openId)) {
                ...
                Map<String, Object> snsApiUserInfoMap = com.newMall.utils.WX_PublicNumberUtil.getSnsApiUserInfo(accessToken, openId);
                ...
                if ((errCode == null || errCode.intValue() == 0)
                    ...
                    //获取用户信息判断是否关注
                    Map<String, Object> cgiBinUserInfoMap = com.newMall.utils.WX_PublicNumberUtil.getCgiBinUserInfo(openId);
    ...
    public ResultMapDTO getToOauthUrl(Map<String, Object> paramMap) {
        ...
        String toOauthUrl = com.newMall.utils.WX_PublicNumberUtil.getAuthorizeURL(NewMallCode.WX_PUBLIC_NUMBER_APPID, calbackUrl, "111", false);
    ...
    public ResultMapDTO enterprisePayment(Map<String, Object> paramMap) {
        ...
        if (paramMap.size() > 0 && !"".equals(wxPublicNumGhId)) {
            ...
            if (dicResultDto.getResultList() != null
                ...
                resultMapDTO = com.newMall.utils.WX_PublicNumberUtil.enterprisePayment(
    ...
    public ResultMapDTO sendRedPacket(Map<String, Object> paramMap) {
        ...
        if (paramMap.size() > 0 && !"".equals(wxPublicNumGhId)) {
            ...
            if (dicResultDto.getResultList() != null
                ...
                //发送红包
                boolean isSend = com.newMall.utils.WX_PublicNumberUtil.sendRedPack(
