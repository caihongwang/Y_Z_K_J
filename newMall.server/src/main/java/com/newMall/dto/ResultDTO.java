...
public class ResultDTO {
    ...
    public Integer allRedPacketMoneyTotal; // required
    ...
    public Integer getAllRedPacketMoneyTotal() {
        return allRedPacketMoneyTotal;
    }

    public void setAllRedPacketMoneyTotal(Integer allRedPacketMoneyTotal) {
