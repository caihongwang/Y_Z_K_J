...
public class SignUtil {
    ...
    public static void main(String[] args) {
        ...
        String url = "https://www.yzkj.store/newMall/common/getSignatureAndJsapiTicketAndNonceStrForWxPublicNumber.do";//url是你请求的一个action或者controller地址，并且方法直接跳转到使用jsapi的jsp界面
    ...
    public static Map<String, String> getSign(String url) {
        ...
        String jsapi_ticket = com.newMall.utils.jsapi.JsapiTicketUtil.getJSApiTicket();
