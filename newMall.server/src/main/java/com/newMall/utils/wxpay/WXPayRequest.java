...
public class WXPayRequest {
    ...
    private String request(String urlSuffix, String uuid, String data, int connectTimeoutMs, int readTimeoutMs, boolean useCert, boolean autoReport) throws Exception {
        ...
        long startTimestampMs = com.newMall.utils.wxpay.WXPayUtil.getCurrentTimestampMs();
        ...
        try {
            ...
            elapsedTimeMillis = com.newMall.utils.wxpay.WXPayUtil.getCurrentTimestampMs() - startTimestampMs;
            config.getWXPayDomain().report(domainInfo.domain, elapsedTimeMillis, null);
            com.newMall.utils.wxpay.WXPayReport.getInstance(config).report(
                    uuid,
                    elapsedTimeMillis,
                    domainInfo.domain,
            ...
            firstHasDnsErr = true;
            elapsedTimeMillis = com.newMall.utils.wxpay.WXPayUtil.getCurrentTimestampMs() - startTimestampMs;
            com.newMall.utils.wxpay.WXPayUtil.getLogger().warn("UnknownHostException for domainInfo {}", domainInfo);
            com.newMall.utils.wxpay.WXPayReport.getInstance(config).report(
                    uuid,
                    elapsedTimeMillis,
                    domainInfo.domain,
            ...
            elapsedTimeMillis = com.newMall.utils.wxpay.WXPayUtil.getCurrentTimestampMs() - startTimestampMs;
            com.newMall.utils.wxpay.WXPayUtil.getLogger().warn("connect timeout happened for domainInfo {}", domainInfo);
            com.newMall.utils.wxpay.WXPayReport.getInstance(config).report(
                    uuid,
                    elapsedTimeMillis,
                    domainInfo.domain,
            ...
            elapsedTimeMillis = com.newMall.utils.wxpay.WXPayUtil.getCurrentTimestampMs() - startTimestampMs;
            com.newMall.utils.wxpay.WXPayUtil.getLogger().warn("timeout happened for domainInfo {}", domainInfo);
            com.newMall.utils.wxpay.WXPayReport.getInstance(config).report(
                    uuid,
                    elapsedTimeMillis,
                    domainInfo.domain,
