...
public class LonLatUtil {
    ...
    public static final Logger logger = LoggerFactory.getLogger(com.newMall.utils.LonLatUtil.class);
    ...
    public static String getAddressByLonLat(Double lon, Double lat, String addressStr) {
        ...
        try {
            HttpResponse response = com.newMall.utils.ALiYunHttpUtils.doGet(host, path, method, headers, querys);
