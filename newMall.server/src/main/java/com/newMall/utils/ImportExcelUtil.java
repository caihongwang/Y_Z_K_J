...
import com.newMall.service.BaseConvert;
import com.newMall.utils.ColumnNameUtils;
...
public class ImportExcelUtil<T> {
    ...
    private boolean validateExcel(String filePath) {
        ...
        if (filePath == null || !(com.newMall.utils.PoiUtils.isExcel2003(filePath) || com.newMall.utils.PoiUtils.isExcel2007(filePath))) {
    ...
    public void read(String filePath, Class<T> clazz, int sheet) {
        ...
        try {
            ...
            if (!flag) {
                if (com.newMall.utils.PoiUtils.isCSV(filePath)) {
            ...
            if (com.newMall.utils.PoiUtils.isExcel2007(filePath)) {
                isExcel2003 = false;
            }
            /** 调用本类提供的根据流读取的方法 */
            File file = new File(filePath);
...
//                    }
    ...
    private Method getMethodByColumnName(String columnName, Class<T> clazz) {
        ...
        for (Field field : fields) {
            ...
            com.newMall.utils.ColumnNameUtils annotation = field.getAnnotation(ColumnNameUtils.class);
            if (annotation != null) {
