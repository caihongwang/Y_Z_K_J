...
import com.newMall.utils.EmojiUtil;
    ...
    public static Map<String, Object> getObjectMap(Map<String, String> paramMap) {
        ...
        if (paramMap != null && paramMap.size() > 0) {
            for (Map.Entry<String, String> entry : paramMap.entrySet()) {
                ...
                try {
                    value = com.newMall.utils.EmojiUtil.emojiConvert(value);
                } catch (Exception e) {
        ...
        objectParamMap.put("createTime", com.newMall.utils.TimestampUtil.getTimestamp());
        objectParamMap.put("updateTime", com.newMall.utils.TimestampUtil.getTimestamp());
    ...
    public static Map<String, String> getStringMap(Map<String, ?> paramMap) {
        ...
        if (paramMap != null && paramMap.size() > 0) {
            for (Map.Entry<String, ?> entry : paramMap.entrySet()) {
                ...
                if (value != null) {
                    try {
                        String valueStr = com.newMall.utils.EmojiUtil.emojiRecovery(value != null ? value.toString() : "");
            ...
            for (Map.Entry<String, Object> entry : paramMap.entrySet()) {
                ...
                try {
                    if (value instanceof JSONObject) {
                        String valueStr = com.newMall.utils.EmojiUtil.emojiRecovery((((JSONObject) value).toJSONString()) != null ? (((JSONObject) value).toJSONString()) : "");
                        stringParamMap.put(key, valueStr);
                    } else if (value instanceof JSONArray) {
                        String valueStr = com.newMall.utils.EmojiUtil.emojiRecovery((((JSONArray) value).toJSONString()) != null ? (((JSONArray) value).toJSONString()) : "");
                        stringParamMap.put(key, valueStr);
                    } else {
