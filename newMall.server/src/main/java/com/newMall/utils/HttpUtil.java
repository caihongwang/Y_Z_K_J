...
public class HttpUtil {
    ...
    private static final Logger logger = LoggerFactory.getLogger(com.newMall.utils.HttpUtil.class);
...
//                        paramValue = URLDecoder.decode(paramValue, characterEncoding);
    ...
    public static String getIpAddr(HttpServletRequest request) {
        ...
        if (com.newMall.utils.StringUtils.isNotEmpty(ip) && !"unKnown".equalsIgnoreCase(ip)) {
