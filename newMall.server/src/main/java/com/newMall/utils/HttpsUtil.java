...
import com.newMall.utils.SSLContextUtil;
import com.newMall.utils.WX_PublicNumberUtil;
...
public class HttpsUtil {
    ...
    private static final Logger logger = LoggerFactory.getLogger(com.newMall.utils.HttpsUtil.class);
...
//    }
    ...
    protected String uploadMedia(String url, File file, String params) throws IOException {
        ...
        com.newMall.utils.IOUtils.closeQuietly(fs);
        // 多个文件时，二个文件之间加入这个
        out.write("\r\n".getBytes());
        if (com.newMall.utils.WX_PublicNumberUtil.notBlank(params)) {
        ...
        out.write(end_data);
        out.flush();
        com.newMall.utils.IOUtils.closeQuietly(out);
        ...
        com.newMall.utils.IOUtils.closeQuietly(in);
        // 关闭连接
        if (conn != null) {
            conn.disconnect();
        }
     ...
     * @throws IOException
     */
    protected com.newMall.utils.MediaFileUtil download(String url) throws IOException {
        com.newMall.utils.MediaFileUtil mediaFile = new com.newMall.utils.MediaFileUtil();
        URL _url = new URL(url);
        HttpURLConnection conn = (HttpURLConnection) _url.openConnection();
        // 连接超时
        conn.setConnectTimeout(25000);
