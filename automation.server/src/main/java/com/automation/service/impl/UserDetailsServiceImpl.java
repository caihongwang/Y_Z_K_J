...
import com.automation.dao.Automation_UserDao;
import com.automation.dto.ResultMapDTO;
import com.automation.secuity.Automation_User;
...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    @Autowired
    private Automation_UserDao automation_UserDao;
...
//        resultMapDTO = automation_WxServiceImpl.login(paramMap);
        //登陆后的用户信息
        ...
        List<Map<String, Object>> userList = automation_UserDao.getSimpleUserByCondition(userParam);
        ...
        return new Automation_User(nickName, password, uid, openId, nickName, avatarUrl, isAdmin, userInfoMap, authorities);
    }
}
