...
import com.automation.domain.MyRedisTokenStore;
...
public class Oauth2ServiceConfig extends AuthorizationServerConfigurerAdapter {
    ...
    @Autowired
    private Automation_DicService automation_DicService; //保存令牌数据栈
    ...
    public JwtAccessTokenConverter accessTokenConverter() {
        JwtAccessTokenConverter accessTokenConverter = new JwtAccessTokenConverter() {
            ...
            public OAuth2AccessToken enhance(OAuth2AccessToken accessToken, OAuth2Authentication authentication) {
                ...
                // 设置额外用户信息
                Automation_User automationCurrentUser = (Automation_User) authentication.getPrincipal();
                // 将用户信息添加到token额外信息中
                defaultOAuth2AccessToken.getAdditionalInformation().put("userInfo", automationCurrentUser);
