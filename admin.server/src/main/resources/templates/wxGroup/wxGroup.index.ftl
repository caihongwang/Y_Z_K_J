				...
				<div class="col-xs-2">
					<div class="input-group">
						<input type="text" class="form-control" id="dicCode" autocomplete="on"
							   placeholder="${I18n.system_please_input}微信群昵称">
					</div>
				</div>
				<div class="col-xs-1">
					<div class="input-group">
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title">更新【微信群】信息</h4>
			</div>
			<div class="modal-body">
				<form class="form-horizontal form" role="form">
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control"  name="addFrirndTotalNumStr" placeholder="${I18n.system_please_input}每次成功添加群成员数量" maxlength="100" onchange="changeDicRemark()">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
                            <textarea class="textarea form-control" name="dicRemark" placeholder="${I18n.system_please_input}业务详情" maxlength="10240000" style="height: 250px; line-height: 1.2;" readonly="true"></textarea>
						</div>
					</div>
...
<script src="${request.contextPath}/static/js/wxGroup.index.1.js"></script>
</body>
</html>
